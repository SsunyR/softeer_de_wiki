...
class HadoopConfigManager:
    ...
    def process_configurations(self):
        ...
        print("Starting Hadoop configuration automation...")
        ...
        try:
            ...
            for xml_file in xml_files:
                ...
                print(f"Completed: {xml_file.name}\n")
            
            print("Configuration automation completed!")
...
def main():
    if len(sys.argv) > 1 and sys.argv[1] in ['-h', '--help']:
        ...
        print()
        print("Example: HADOOP_CONF_DIR=/path/to/hadoop/etc/hadoop python3 hadoop_config_manager.py")
        return
